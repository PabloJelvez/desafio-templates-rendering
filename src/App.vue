    ...
    <div class="container p-5">
      <div class="containerForm">
        ...
        <div>
          ...
          <input type="range" id="rangeBorder" name="rangeBorder" min="0" max="50" step="1" v-model="radiusElement">
        ...
        <div class="element" :style="{ backgroundColor: color2(), borderRadius: radiusElement + '%' }">
          <div v-show="texto === true">
            <p :class="{ 'pequeño': tamañoLetra == 'pequeño', 'mediano': tamañoLetra == 'mediano', 'grande': tamañoLetra == 'grande' }"
              :style="{ fontFamily: tipografiaSeleccionada, color: colorTexto }">{{ textArea }}</p>
          </div>
        </div>
      </div>
    </div>
